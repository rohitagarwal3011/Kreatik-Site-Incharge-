...
import com.app.rbc.siteincharge.activities.RequirementDetailActivity;
...
import com.app.rbc.siteincharge.models.VehicleDetail;
...
public class RequirementDetails extends Fragment {
    ...
    public com.app.rbc.siteincharge.models.RequirementDetails requirementDetails;
    ...
    public void get_data() {
        ...
        Call<com.app.rbc.siteincharge.models.RequirementDetails> call = apiServices.req_details(RequirementDetailActivity.rq_id);
        ...
        call.enqueue(new Callback<com.app.rbc.siteincharge.models.RequirementDetails>() {
            @Override
            public void onResponse(Call<com.app.rbc.siteincharge.models.RequirementDetails> call, Response<com.app.rbc.siteincharge.models.RequirementDetails> response) {
                pDialog.dismiss();
                if (response.body().getMeta().getStatus() == 2) {
                    ...
                    requirementDetails = new Gson().fromJson(new Gson().toJson(response.body()), com.app.rbc.siteincharge.models.RequirementDetails.class);
...
//                    }
            ...
            @Override
            public void onFailure(Call<com.app.rbc.siteincharge.models.RequirementDetails> call1, Throwable t) {
    ...
    private void setData() {
        ...
        com.app.rbc.siteincharge.models.RequirementDetails.ReqDetail.Detail reqDetail = requirementDetails.getReqDetails().get(0).getDetails().get(0);
