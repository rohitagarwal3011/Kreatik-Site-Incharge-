package com.app.rbc.siteincharge.api;
...
import com.app.rbc.siteincharge.activities.ProfileActivity;
import com.app.rbc.siteincharge.activities.ReportActivity;
import com.app.rbc.siteincharge.activities.SiteOverviewActivity;
import com.app.rbc.siteincharge.activities.Splash;
import com.app.rbc.siteincharge.fragments.InitialSyncFragment;
import com.app.rbc.siteincharge.interfaces.ApiServices;
import com.app.rbc.siteincharge.models.AllSiteList;
...
import com.app.rbc.siteincharge.models.db.models.User;
import com.app.rbc.siteincharge.models.db.models.Vehicle;
import com.app.rbc.siteincharge.models.db.models.Vendor;
import com.app.rbc.siteincharge.models.db.models.site_overview.Requirement;
import com.app.rbc.siteincharge.models.db.models.site_overview.Stock;
import com.app.rbc.siteincharge.models.db.models.site_overview.Trans;
...
public class APIController{
    ...
    public void getEmployeeList() {
        ...
        Call<com.app.rbc.siteincharge.models.Employee> call2 = apiServices.fetch_emp(AppUtil.getString(context, TagsPreferences.USER_ID));
        ...
        call2.enqueue(new Callback<com.app.rbc.siteincharge.models.Employee>() {
            @Override
            public void onResponse(Call<com.app.rbc.siteincharge.models.Employee> call2, Response<com.app.rbc.siteincharge.models.Employee> response) {

                com.app.rbc.siteincharge.models.Employee employee = response.body();
            ...
            @Override
            public void onFailure(Call<com.app.rbc.siteincharge.models.Employee> call2, Throwable t) {
